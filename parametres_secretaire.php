...
$sql = "SELECT nom_secretaire as nom, prenom_secretaire as prenom, tel_secretaire as telephone, email_secretaire as email, photo, mot_de_passe 
        FROM secretaire WHERE id_secretaire = :id";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!$message) { // Exécute uniquement si aucun message d'erreur
        $sql = "UPDATE secretaire SET nom_secretaire = :nom, prenom_secretaire = :prenom, tel_secretaire = :telephone, 
                email_secretaire = :email, photo = :photo";
        ...
        header("Location: parametres_secretaire.php");
        exit();
    }
}
?>
